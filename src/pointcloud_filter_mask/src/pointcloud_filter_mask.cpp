...
ros::Publisher pub_floor, pub_static;
...
int main (int argc, char** argv)
{
    ...
    ros::Subscriber sub_map = nh.subscribe<nav_msgs::OccupancyGrid> ("/map", 1, map_2d_cb);

    //pub_move = nh.advertise<sensor_msgs::PointCloud2> ("/obstacle_on_road", 1);
